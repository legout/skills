...
Use `improve-skill` instead when the request is to diagnose or revise one skill from a specific coding-agent session. This skill mines a broader recent corpus for cross-cutting preferences, rules, and workflows.

## Scope

- Default to the last 7 days unless the user asks for a different window.
- Use the host's supported Cursor chat-history access. If it is unavailable, ask for a user-provided export; do not scrape private application databases.
...
Adapted from [`cursor/plugins`](https://github.com/cursor/plugins/tree/93b00b89ef425a9c1bac0d0b317dfc49c930ac99/cursor-team-kit/skills/workflow-from-chats) at commit `93b00b89ef425a9c1bac0d0b317dfc49c930ac99` (MIT).
