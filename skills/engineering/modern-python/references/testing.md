...
Configuration and best practices for pytest with optional coverage enforcement. Preserve an existing suite's markers, warning policy, and coverage threshold; examples are starting points, not migration authority.
...
# Open htmlcov/index.html with the platform's browser or artifact viewer
