...
1. Copy `.github/actions/drawio-diff/` and `skills/visualization/drawio-skill/` (or at
...
```
python3 skills/visualization/drawio-skill/scripts/prdiff.py --base origin/main --head HEAD \
