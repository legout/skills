...
> Pattern guidance adapted from [`blader/humanizer`](https://github.com/blader/humanizer/tree/e2e92e7b4b8229253ed5c8e81dc65463fdeddda5) and [`cursor/plugins`](https://github.com/cursor/plugins/tree/93b00b89ef425a9c1bac0d0b317dfc49c930ac99) at the pinned commits recorded in `sources.json`.
...
## Restore voice when the source calls for it

Removing patterns can leave personal writing sterile. When the source, writing sample, or user clearly supports an informal voice:

- preserve opinions and specific reactions instead of flattening them into neutral pros and cons;
- vary sentence length and rhythm rather than making every paragraph mechanically balanced;
- retain first person, humor, uncertainty, asides, and deliberate rough edges;
- prefer concrete details over generic feelings; and
- acknowledge genuine tension instead of forcing a tidy conclusion.

Do not invent a personality or opinion. Formal, legal, technical, and reference text may be intentionally neutral.
...
## Additional plain-language checks
