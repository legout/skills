...
> Origin: adopted from [David Ondrej's `handoff` skill](https://github.com/davidondrej/skills/tree/11dee2ebc2d045806b686ba0b57746f1e3d7e331/skills/agent-orchestration/handoff), MIT, Copyright (c) 2026 David Ondrej. See `THIRD_PARTY_NOTICES.md`.
